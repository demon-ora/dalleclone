...
import { getRandomPrompt } from '../uitl'
...
if(form.prompt && form.photo){
 ...
 <div>
            ...
            <p className='mt-2 text-[#666e75] text-[16px] max-w-[500px]'>Create imaginative and visulallly stunning images through DALL-E AI and share them with the community</p>
        </div>
     ...
     <FormField 
            ...
            type="text"
            name="prompt"
            placeholder="a plush toy robot sitting againt a yellow wall"
            value={form.prompt}
            handleChange={handleChange}
            isSurpriseMe
         ...
         <button type='button' onClick={generateImage} className="text-white bg-green-700 font-medium rounded-md text-sm w-full sm:w-auto px-5 py-2.5 text-center">
          ...
          <div className='mt-10'>
            <p className='mt-2 text-[#666e75] text-[14px]'>
               once you have created the image you can share it with otehr in the community
            </p>
               <button type="submit" className='mt text-white bg-[#6469ff] font-medium rounded-md text-sm w-full sm:w-auto px-5 py-2.5 text-center'>
